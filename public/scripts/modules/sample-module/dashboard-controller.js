define(['angular', './sample-module'], function (angular, controllers) {
    ...
    controllers.controller('DashboardsCtrl', ['$scope', '$log', '$location','PredixAssetService', 'PredixViewService', function ($scope, $log, $location, PredixAssetService, PredixViewService) {
